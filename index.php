...
<head>
    <title><? echo lang('welcome'); ?> | HowX Network</title>
    <meta charset="UTF-8">
    <meta name="description" content="HowX Network is a social network platform helps you meet new friends and stay connected with your family and with who you are interested anytime anywhere.">
    <meta name="keywords" content="homepage,main,login,social network,social media,HowX Network,meet,free platform">
    ...
    <!--============[ Nav bar ]============-->
        <div class="login_signup_navbar">
                <a href="index" class="login_signup_navbarLinks">HowX Network</a>
        ...
        <h3 align="center"><? echo lang('welcome_to'); ?> HowX Network</h3>
        <p align="center" style="color: #999; margin-bottom: 25px;"><? echo lang('wallstant_main_string'); ?>.</p>
            <div style="display: flex;">
                ...
                <div style="width: 100%;text-align: center;">
                    <img src="imgs/main_icons/pc_main.png" alt="HowX Network" style="width: 300px;" />
                </div>
            </div>
        </div>
