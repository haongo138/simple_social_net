...
<head>
    <title><?php echo "Hashtag - ".$_GET['tag'];if($_GET['tag'] == 'search'){echo "Hashtag";} ?> | HowX Network</title>
    <meta charset="UTF-8">
    ...
    <meta name="keywords" content="hashtag,social network,social media,HowX Network,meet,free platform">
